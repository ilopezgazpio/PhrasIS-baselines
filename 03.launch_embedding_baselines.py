...
parser.add_argument('--embeddings', default='src/Embeddings_baselines/fasttext.vec', help='the word embeddings txt file')
...
for evaluation_dataset in test_datasets:
    ...
    # Compute score
    print(evaluation_dataset + " : " + str(utils.pearson(sys, ref)))