...
LEXICAL_COLS       = ['jaccard_strip_tokenized', 'jaccard_strip_tokenized_noPunct_lemmat_noStopWords', 'jacckard_strip_tokenized_noPunct_lemmat']
...
LENGTH_COLS        = ['left_strip_tokenized_len', 'right_strip_tokenized_len','left-right', 'right-left', '|chunk1-chunk2|',]
